...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="../images/logo.png" class="h-14" alt="e-commLogo" />
        </a>
        <div class="flex items-center md:order-2 space-x-3 rtl:space-x-reverse">
            ...
            <div class="relative hidden mr-8 md:block">
            ...
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full object-cover object-center"
                    src="https://preview.redd.it/what-do-you-think-about-bocchi-as-a-character-v0-93h9o0z5iqba1.jpg?width=640&crop=smart&auto=webp&s=e7d33f8229d4ffd3b96d22e989a98c8e4ead8fe6"
                    alt="user photo">
            </button>
